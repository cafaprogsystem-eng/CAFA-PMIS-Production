...
const TARGETS = [
  ...
  { key: "plans", urlPath: "/plans", auth: true, style: "full" },
  { key: "notifications", urlPath: "/notifications", auth: true, style: "full" },
  { key: "messages", urlPath: "/messages", auth: true, style: "full" },
  { key: "file-archive", urlPath: "/document-management/file-archive", auth: true, style: "full" },
