...
>(({ className, ...props }, ref) => (
  <tr
    ...
    className={cn(
      ...
      "hover:bg-accent/30 data-[state=selected]:bg-accent/50",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-10 px-4 text-start align-middle text-xs font-semibold uppercase tracking-widest text-muted-foreground",
