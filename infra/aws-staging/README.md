...
## Administrator access after initial bootstrap

The one-time staging administrator bootstrap path was removed after the initial
Super Admin account was created successfully. It must not be reintroduced for
normal account or password management.

Future administrator password recovery uses the normal authenticated user
management or public forgot-password/reset-password workflow.
