...
export declare const getGetBeneficiariesBreakdownUrl: (params?: GetBeneficiariesBreakdownParams) => string;
/**
 * @summary Beneficiary segregation aggregated from project forms
 */
export declare const getBeneficiariesBreakdown: (params?: GetBeneficiariesBreakdownParams, options?: RequestInit) => Promise<BeneficiariesBreakdown>;
export declare const getGetBeneficiariesBreakdownQueryKey: (params?: GetBeneficiariesBreakdownParams) => readonly ["/api/dashboard/beneficiaries", ...GetBeneficiariesBreakdownParams[]];
export declare const getGetBeneficiariesBreakdownQueryOptions: <TData = Awaited<ReturnType<typeof getBeneficiariesBreakdown>>, TError = ErrorType<unknown>>(params?: GetBeneficiariesBreakdownParams, options?: {
 ...
 * @summary Beneficiary segregation aggregated from project forms
 */
export declare function useGetBeneficiariesBreakdown<TData = Awaited<ReturnType<typeof getBeneficiariesBreakdown>>, TError = ErrorType<unknown>>(params?: GetBeneficiariesBreakdownParams, options?: {
    query?: UseQueryOptions<Awaited<ReturnType<typeof getBeneficiariesBreakdown>>, TError, TData>;
    request?: SecondParameter<typeof customFetch>;
}): UseQueryResult<TData, TError> & {
    queryKey: QueryKey;
